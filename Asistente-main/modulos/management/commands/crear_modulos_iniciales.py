...
from modulos.models import ModuloEstudio, Leccion

class Command(BaseCommand):
    help = 'Crear módulos iniciales de estudio'
    ...
    def handle(self, *args, **options):
        ...
        for modulo_data in modulos_data:
            ...
            if created:
                self.stdout.write(f'Módulo "{modulo.titulo}" creado.')
                ...
                self.stdout.write(f'  Lecciones creadas para "{modulo.titulo}".')
            else:
                self.stdout.write(f'Módulo "{modulo.titulo}" ya existe.')

        self.stdout.write('Módulos iniciales creados exitosamente.')
